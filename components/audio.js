...
const Slider = ({ min, max, step, value, onInput, className }) => {
    ...
    return (React.createElement("div", { className: `slider ${className}-slider` },
        ...
        React.createElement("input", { type: "range", className: className, min: min, max: max, step: step, value: value, onInput: onInput })));
};
const TimeLine = ({ duration, paused }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("time", null,
            ...
            durationTimeTag),
        React.createElement(Slider, { min: 0, max: duration, step: 1, value: currentTime, className: "time-line", onInput: onInput })));
};
